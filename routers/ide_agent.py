...
"""
        ...
        is_ollama = not is_gemini  # Default to Ollama for local models

        # 4. Stream Response
        async def token_generator():
            # Send system prompt metadata for debugging panel
            yield f"data: {json.dumps({'system_prompt': system_prompt[:200] + '...', 'model': model})}\n\n"
            ...
            try:
                ...
                yield f"data: {json.dumps({'error': str(e), 'content': f'Error: {e}'})}\n\n"
